...
import { buscarTodosComunicadosInstrutor } from '@/features/instrutor/actions/comunicados'
...
export default async function InstrutorComunicadosPage({ params }: Props) {
  ...
  const comunicados = await buscarTodosComunicadosInstrutor(autoescola.id, session.instructorId)
