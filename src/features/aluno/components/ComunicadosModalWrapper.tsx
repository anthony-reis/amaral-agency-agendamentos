...
import { marcarComunicadoComoLido } from '@/features/aluno/actions/comunicados'
...
export function ComunicadosModalWrapper({ comunicados, studentDocument, autoescolaId, escola }: Props) {
  ...
  function handleEntendido() {
    ...
    startTransition(async () => {
      await marcarComunicadoComoLido(id, autoescolaId, studentDocument, escola)
